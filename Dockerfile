...
RUN CGO_ENABLED=0 go build -tags netgo -ldflags "-X github.com/morawskidotmy/transfer.ng/cmd.Version=$(git describe --tags 2>/dev/null || echo 'unknown') -a -s -w -extldflags '-static'" -o /go/bin/transfersh
